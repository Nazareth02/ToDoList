...
var _renderCard1Js = require("./_render-card1.js");
var _renderCard1JsDefault = parcelHelpers.interopDefault(_renderCard1Js);
var _renderCard2Js = require("./_render-card2.js");
var _renderCard2JsDefault = parcelHelpers.interopDefault(_renderCard2Js);
var _renderCard3 = require("./_render-card3");
var _renderCard3Default = parcelHelpers.interopDefault(_renderCard3);
var _renderFromLocalJs = require("./_renderFromLocal.js");
...
if (dateDay < 10) dateOut.textContent = "0" + dateDay + "." + dateMonth + "." + dateYear;
//  -----------------------------------------------//
...
if (localStorage.getItem("key") || localStorage.getItem("keyProg") || localStorage.getItem("keyDone")) {
    ...
    function displayMessages() {
        MakeToDo.forEach(function(item, idx) {
            MakeWrap.innerHTML += (0, _renderFromLocalJs.renderFromLocal)(item, idx);
        });
        InProgress.forEach(function(item, idx) {
            ProgWrap.innerHTML += (0, _renderFromLocalJs.renderFromLocalProg)(item, idx);
            TotalNumSecond.innerHTML = InProgress.length;
        });
        Done.forEach((item, idx)=>{
            DoneWrap.innerHTML += (0, _renderCard3Default.default)(item, idx);
...
createBtn.addEventListener("click", (e)=>{
    e.preventDefault();
    // Validation
    if (!userDesc.value || !userTitle.value) return;
    //
    let task = new CreateObject(userTitle.value, userDesc.value, userAuthor.value);
    MakeToDo.push(task);
    MakeWrap.innerHTML = ""; //Эта строчка решила все мои проблемы)))
    MakeToDo.forEach(function(item, idx) {
        MakeWrap.innerHTML += (0, _renderCard1JsDefault.default)(item, idx);
    });
...
function MoveTask(e) {
    if (e.target.dataset.action === "progress") {
        ...
        if (MakeToDo.length == 0) TotalNum.innerHTML = "0";
        InProgress.forEach(function(item, idx) {
            ProgWrap.innerHTML += (0, _renderCard2JsDefault.default)(item, idx);
            TotalNumSecond.innerHTML = InProgress.length;
        });
        localUpdate();
        localUpdateProgress();
...
function MoveTaskDone(e) {
    if (e.target.dataset.action === "done") {
        ...
        InProgress.forEach((el, idx)=>{
            ProgWrap.innerHTML += (0, _renderCard2JsDefault.default)(el, idx);
            TotalNumSecond.innerHTML = InProgress.length;
        });
        if (InProgress.length == 0) TotalNumSecond.innerHTML = "0";
        Done.forEach((el, idx)=>{
            DoneWrap.innerHTML += (0, _renderCard3Default.default)(el, idx);
            TotalNumThird.innerHTML = Done.length;
        });
    }
    localUpdateProgress();
...
},{"./_render-card1.js":"euQx0","./_render-card2.js":"f8WrK","./_render-card3":"kFGyS","./_renderFromLocal.js":"bx2LO","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"euQx0":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
function renderMakeToDo(item, i) {
...
exports.default = renderMakeToDo;
...
},{}],"f8WrK":[function(require,module,exports) {
...
exports.default = renderInProg;

},{"./_render-card2.js":"f8WrK","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"kFGyS":[function(require,module,exports) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"bx2LO":[function(require,module,exports) {
// import {renderFromLocal} from "./_renderFromLocal.js";
// ------------------------------------------------------------
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "renderFromLocal", ()=>renderFromLocal);
parcelHelpers.export(exports, "renderFromLocalProg", ()=>renderFromLocalProg);
function renderFromLocal(item, i) {
    return `<li class="list_item-task" id="${i}">
    <h3 class="task-title">${item.title}</h3>
    <p class="task-description">${item.description}</p>
    <p class="task-author">${item.author}</p>
...
function renderFromLocalProg(item, i) {
    return `<li class="list_item-task" id="${i}">
    <h3 class="task-title">${item.title}</h3>
    <p class="task-description">${item.description}</p>
    <p class="task-author">${item.author}</p>
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["cVgJb","ebWYT"], "ebWYT", "parcelRequire5c64")
